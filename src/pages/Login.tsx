...
const BananaLogo = () => (
  <svg viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-12 h-12">
    <defs>
      <linearGradient id="loginBananaGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex flex-col space-y-4">
            ...
            <p className="text-sm text-[hsl(var(--muted-foreground))] text-center">
              还没有账户？{' '}
              <Link to="/register" className="text-[hsl(var(--banana))] hover:underline font-medium">
                立即注册
              </Link>
            </p>
          </CardFooter>
